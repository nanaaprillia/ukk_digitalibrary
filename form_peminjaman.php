        ...
        <div class="content mt-3">
            <div class="card bg-success bg-gradient">
                <div class="card-body">
                    ...
                    <a href="http://localhost/digitalibrary/index.php?pesan=info_logout/logout.php" class="btn text-light">LOGOUT</a>
                </div>
            </div>
        </div>
        <div class="container">
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    echo "<tr><td>".$row["PeminjamanID"]."</td><td>".$row["UserID"]."</td><td>".$row["BukuID"]."</td><td>".$row["TanggalPeminjaman"]."</td><td>".$row["TanggalPeminjaman"]."</td><td>";
