                ...
                if (xhr.readyState == 4 && xhr.status == 200) {
                    ...
                    dataKategori.forEach(function (kategori) {
                        ...
                        newRow.innerHTML = `
                            ...
                            <td>
                                <button onclick="editKategori(${kategori.KategoriID})" class="btn btn-primary">  <a href=" http://localhost/digitalibrary/admin/edit_kategori.php" class ="btn text-light">EDIT</a>
                                </button>                            
